...
if($_SERVER['REQUEST_METHOD']=='POST'){
  ...
  if(isset($_POST['user-login'])){
    ...
    if ( $logintype == 'user' ) {
      ...
      $_SESSION['user_set']=1;
      $number = $_POST['number'];
      $result = $mysqli->query( "SELECT * FROM u_gen_info WHERE m_no=$number" );
  ...
  elseif (isset($_POST['pharma-login'])) {
    ...
    if ( $logintype == 'pharma' ) {
      ...
      $result = $mysqli->query( "SELECT * FROM pharm_reg WHERE phone=$number" );
      if ( $result->num_rows == 0 ) { // User doesn't exist
                $errMSG = "User does'n exist!!";
    }
      ...
      <div class="container margin_60_35">
        <div class="tab-container">
          <table align="center" width="300" class="nav nav-tabs">
            <tr>
              <td align="center"><a href="#user_login" data-toggle="tab" class="nav-link active">Patient</a></td>
          ...
          <div class="tab-content">
            <div id="user_login" class="tab-pane cont active fadeInUp animated" >
              <div id="login">
                <h1>Welcome Patient, Please login here!</h1>
                <div class="box_form">
                  <form method="post">
                    <div class="form-group">
                      <input type="tel" class="form-control" placeholder="Your Health ID" name="number" required>
                    </div>
                    <div class="form-group">
